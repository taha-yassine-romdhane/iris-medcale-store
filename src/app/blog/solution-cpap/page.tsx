        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 text-center flex flex-col items-center">
            <div className="bg-white rounded-lg mb-4 min-h-[220px] flex flex-col justify-between items-center w-full">
              <img src="/catalogue photo/cpap yuwell YH-680.jpg" alt="CPAP Yuwell YH-680" className="h-56 object-contain mx-auto" />
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 text-center flex flex-col items-center">
            <div className="bg-white rounded-lg p-6 mb-4 min-h-[160px] flex items-center justify-center w-full">
              <img src="/catalogue photo/yh-550.webp" alt="CPAP Yuwell YH-550" className="h-40 object-contain mx-auto" />
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-200 text-center flex flex-col items-center">
            <div className="bg-white rounded-lg mb-4 min-h-[220px] flex flex-col justify-between items-center w-full">
              <img src="/catalogue photo/yh-350.webp" alt="CPAP Yuwell YH-350" className="h-56 object-contain mx-auto" />
            </div>
