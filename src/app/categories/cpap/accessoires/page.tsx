  ...
  return (
    ...
    <div className="relative bg-blue-600 text-white overflow-hidden">
      ...
      <div className="absolute bottom-0 w-full">
        <svg className="w-full h-12 sm:h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path fill="#f3f4f6" fillOpacity="1" d="M0,96L1440,224L1440,320L0,320Z"></path>
        </svg>
      </div>
    </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product) => (
            ...
            >
              {/* Main Product Image */}
              <div className="relative aspect-w-1 aspect-h-1 h-48">
              ...
              <div className="p-4">
                ...
                <div className="mt-4">
                  <ul className="text-sm text-gray-600 space-y-1">
                    {JSON.parse(product.features).slice(0, 2).map((feature: string, index: number) => (
