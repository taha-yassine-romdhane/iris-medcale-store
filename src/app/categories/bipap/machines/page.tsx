...
export default function BipapMachinesPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        // Fetch only BiPAP machines
        const response = await fetch('/api/products?category=bipap&type=Machine');
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Découvrez notre sélection de machines BiPAP de haute qualité.
              Une solution avancée pour le traitement de l&apos;apnée du sommeil avec deux niveaux de pression.
            </p>
          </div>
        </div>
