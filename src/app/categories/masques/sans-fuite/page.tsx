...
export default function NasalMasksPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const { products, initialSelectedMedia } = await fetchCategoryProducts('sans-fuite');
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Découvrez notre sélection de masques SANS FUITES confortables et efficaces pour votre traitement par PPC.
