...
export default function FacialMasksPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        // Fetch only facial masks
        const response = await fetch('/api/products?type=Masque Facial');
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Découvrez notre gamme de masques faciaux complets pour votre traitement par PPC.
              Confort optimal et étanchéité parfaite pour une thérapie efficace.
            </p>
          </div>
        </div>
