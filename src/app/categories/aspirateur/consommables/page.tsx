...
export default function AspiratorConsumablesPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        // Fetch only aspirator consumables
        const response = await fetch('/api/products?category=aspirateur&type=Consommable');
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-300">
              Consommables pour Aspirateurs
            </h1>
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Découvrez notre gamme complète de consommables pour aspirateurs médicaux.
              Des produits essentiels pour maintenir l&apos;hygiène et l&apos;efficacité de votre équipement.
            </p>
          </div>
        </div>
